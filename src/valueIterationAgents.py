...
class ValueIterationAgent(ValueEstimationAgent):
    """
        Um agente que usa Iteração de Valor para resolver um MDP.
        Este agente calcula a política ótima e os valores de estado
        para um dado MDP, número de iterações e fator de desconto.
    """
    ...
    def getValue(self, state):
        ...
        Este método é chamado por outras partes do sistema.
        """
    ...
    def getAction(self, state):
        ...
        Este método é usado para executar ações no ambiente.
        """
        return self.computeActionFromValues(state)
